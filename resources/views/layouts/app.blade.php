...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .card { background:#fff; padding:16px; border-radius:8px; box-shadow: 0 6px 18px rgba(11,20,40,0.06); }
            .task { padding:12px; border-radius:6px; background:#fafafa; margin-bottom:8px; cursor:grab; display:flex; justify-content:space-between; align-items:center; }
            .task .left { display:flex; gap:12px; align-items:center; }
            .task .priority { width:36px; text-align:center; font-weight:bold; opacity:0.7; }
            .task .name { font-weight:600; }
            .controls a, .controls form { display:inline-block; margin-left:6px; }
            .project-select { margin-bottom:16px; }
            .small { font-size:0.9rem; color:#666; }
            .btn { padding:8px 12px; border-radius:6px; text-decoration:none; border:1px solid #ddd; background:#fff; }
